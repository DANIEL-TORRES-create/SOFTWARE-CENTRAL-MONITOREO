(function () {
  ...
  class ArdepeUI {
    ...
    bind() {
      ...
      if (this.$('drive-home')) this.$('drive-home').onclick = () => this.goDriveHome();
    ...
    goDriveHome() {
      try { window.open('geotabdrive://main','_self'); }
      catch (_) {
        const navigate=this.api&&this.api.mobile&&this.api.mobile.navigate;
        if(navigate)navigate('other');else history.back();
      }
    }
    all() {
    ...
    guide() {
      ...
      const topics=this.role==='driver'?
        [
          ['solicitud','Responder una solicitud','<ol><li>Abra <b>Nuevos</b> y seleccione la atención.</li><li>Revise vehículo, fecha, lugar y valor detectado.</li><li>Escriba su versión y adjunte evidencia si corresponde.</li><li>Pulse <b>Enviar mensaje</b>.</li></ol>'],
          ...
          ['estados','Casos e historial','<p><b>Activos</b> reúne casos pendientes. <b>Nuevos</b> muestra mensajes sin leer. <b>Finalizados</b> contiene atenciones terminadas desde esta implementación. <b>Historial</b> permite consultar por fechas.</p>']
        ]:
        [
          ...
          ['evento','Atender un evento','<ol><li>Revise Eventos Geotab.</li><li>Seleccione un evento y valide conductor, vehículo, ubicación y valor.</li><li>Pulse <b>Iniciar atención</b>. Solo entonces se registra en Sheets.</li></ol>'],
